...
<!-- <footer id="footer" class="clearfix">
				...
				<div class="row">
					<div class="col-sm-6 col-md-2">
						<div id="meta-3" class="widget widgetFooter widget_meta">
							...
							<ul>
								...
								<li><a href="privacypolicy.php"><i class="fa fa-link"></i>  
										Privacy Policy</a></li>
					...
					<div class="col-sm-6 col-md-2">
						<div id="recent-posts-3"
							...
							<ul>
								<li><a href="https://www.facebook.com/mr.dauod"
									target="_blank"><i class="fa fa-facebook"></i> Facebook</a></li>
								<li><a href="https://www.twitter.com/ayatquranCom"
									target="_blank"><i class="fa fa-twitter"></i> Twitter</a></li>
								<li><a href="http://www.youtube.com/user/sonsofye"
	...
	<div id="sub-floor">
		<div class="container">
			<div class="row">
				<div class="col-md-4 copyright">Copy right for Faploo © 2015</div>
